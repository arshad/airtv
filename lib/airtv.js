...
exports.check = function (name) {
  ...
  exports.getSeriesByName(name, false, function(error, response, body) {
    // Handle error.
          ...
          if (error) {
            ...
            exports.getLastEpisodeAiredFromResult(result, function(error, episode, position) {
              if (error) {
                ...
                exports.formatEpisodesTable([previousEpisode], 'Previous episode', 'grey', function(table) {
                  console.log(table.toString());
                });

                // Show current episode.
                exports.formatEpisodesTable([episode], 'Current episode', 'yellow', function(table) {
                  console.log(table.toString());
                });

                // Show next episode.
                var nextEpisode = exports.getEpisodeFromResult(position + 1, result);
                exports.formatEpisodesTable([nextEpisode], 'Next episode', 'grey', function(table) {
                  console.log(table.toString());
                });
              }
            });
...
exports.formatEpisodesTable = function(episodes, heading, color, callback) {
 ...
 *  Callback.
 */
exports.getSeriesByName = function(name, loadEpisodes, callback) {
  if (name) {
    var options = {
      seriesname: name
    }
